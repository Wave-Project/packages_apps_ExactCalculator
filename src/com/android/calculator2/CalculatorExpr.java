...
class CalculatorExpr {
    ...
    private static final TokenKind[] tokenKindValues = TokenKind.values();
    private final ArrayList<Token> mExpr;  // The actual representation
    ...
    private static class Constant extends Token implements Cloneable {
        private static final int SAW_DECIMAL = 0x1;
        private static final int HAS_EXPONENT = 0x2;
